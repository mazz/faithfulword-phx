...
# FaithfulwordWeb.Endpoint.init/2 when load_from_system_env is
...
config :faithfulword, FaithfulwordWeb.Endpoint,
  ...
  server: true,
  root: ".",
  version: Application.spec(:faithfulword, :vsn),
...
# start per endpoint:
#
#     config :faithfulword, FaithfulwordWeb.Endpoint, server: true
#
