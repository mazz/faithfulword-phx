...
''')
    ...
    def normalizepreaching(self):
        ...
        self._insertmediaitemrows(self._preachingrows(9, 'Strong Hold Baptist Church Sermons', args.dbname), k_media_category["preaching"], args.dbname)
