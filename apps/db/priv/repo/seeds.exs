...
amos_changeset = User.registration_changeset(%User{reputation: 4200, username: "amos", name: "Amos", locale: "en", is_publisher: true, uuid: Ecto.UUID.generate()}, %{email: "amos@faithfulword.app", password: "password"})
Repo.insert(amos_changeset)
amos_query = Ecto.Query.from(u in User, where: u.username == "amos")
amos = Repo.one!(amos_query)

peter_changeset = User.registration_changeset(%User{reputation: 4200, username: "peter", name: "Peter", locale: "en", is_publisher: true, uuid: Ecto.UUID.generate()}, %{email: "peter@faithfulword.app", password: "password"})
Repo.insert(peter_changeset)
peter_query = Ecto.Query.from(u in User, where: u.username == "peter")
peter = Repo.one!(peter_query)

joseph_changeset = User.registration_changeset(%User{reputation: 4200, username: "joseph", name: "Joseph", locale: "en", is_publisher: true, uuid: Ecto.UUID.generate()}, %{email: "joseph@faithfulword.app", password: "password"})
Repo.insert(joseph_changeset)
joseph_query = Ecto.Query.from(u in User, where: u.username == "joseph")
joseph = Repo.one!(joseph_query)

adam_changeset = User.registration_changeset(%User{reputation: 4200, username: "adam", name: "Adam", locale: "en", is_publisher: true, uuid: Ecto.UUID.generate()}, %{email: "adam@faithfulword.app", password: "password"})
...
jonathan_changeset = User.registration_changeset(%User{reputation: 4200, username: "jonathan", name: "Jonathan", locale: "en", is_publisher: true, uuid: Ecto.UUID.generate()}, %{email: "jonathan@faithfulword.app", password: "password"})
...
collin_changeset = User.registration_changeset(%User{reputation: 4200, username: "collin", name: "Collin", locale: "en", is_publisher: true, uuid: Ecto.UUID.generate()}, %{email: "collin@faithfulword.app", password: "password"})
Repo.insert(collin_changeset)
collin_query = Ecto.Query.from(u in User, where: u.username == "collin")
collin = Repo.one!(collin_query)

mark_changeset = User.registration_changeset(%User{reputation: 4200, username: "mark", name: "Mark", locale: "en", is_publisher: true, uuid: Ecto.UUID.generate()}, %{email: "mark@faithfulword.app", password: "password"})
Repo.insert(mark_changeset)
mark_query = Ecto.Query.from(u in User, where: u.username == "mark")
mark = Repo.one!(mark_query)

michael_changeset = User.registration_changeset(%User{reputation: 4200, username: "michael", name: "Michael", locale: "en", is_publisher: true, uuid: Ecto.UUID.generate()}, %{email: "michael@faithfulword.app", password: "password"})
