defmodule FaithfulWord.DB.Schema.UserAction do
  @moduledoc """
  ...
  alias FaithfulWord.DB.Schema.{UserAction, User} #, Video, Speaker, Comment, Statement}

  schema "users_actions" do
    belongs_to(:user, User)
    belongs_to(:target_user, User)

    field(:type, FaithfulWord.DB.Type.UserActionType)
    field(:entity, FaithfulWord.DB.Type.Entity)
    field(:changes, :map)
