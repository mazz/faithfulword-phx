defmodule FaithfulWord.Accounts.UserPermissions do
  @moduledoc """
  ...
  @limitations_file Path.join(:code.priv_dir(:faithful_word), "limitations.yaml")
  @external_resource @limitations_file
  @limitations FaithfulWord.Utils.load_yaml_config(@limitations_file)
