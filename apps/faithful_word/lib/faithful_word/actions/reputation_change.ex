defmodule FaithfulWord.Actions.ReputationChange do
  @moduledoc """
  Calculate reputation changes.
  """

  alias FaithfulWord.DB.Schema.{User, UserAction}
  alias FaithfulWord.DB.Query.Actions
  ...
  # numerical value.
  @reputations_file Path.join(:code.priv_dir(:faithful_word), "reputation_changes.yaml")
