defmodule FaithfulWord.Accounts.Invitations do
  @moduledoc """
  Invitation system. Generate invites, validate them...

  Can be bypassed by setting the {:faithful_word, :invitation_system} env variable
  ...
  alias FaithfulWord.DB.Utils.TokenGenerator
  ...
  """
  def enabled?, do: Application.get_env(:faithful_word, :invitation_system)

  @doc """
  Enable the invitation system
  """
  def enable, do: Application.put_env(:faithful_word, :invitation_system, true)

  @doc """
  Disable the invitation system
  """
  def disable, do: Application.put_env(:faithful_word, :invitation_system, false)
  ...
  def send_invite(request = %InvitationRequest{}) do
    ...
    |> FaithfulWord.Mailer.Email.invitation_to_register()
  ...
  def generate_invites(number, token) do
    ...
    frontend_url = Application.fetch_env!(:faithful_word, :frontend_url)
