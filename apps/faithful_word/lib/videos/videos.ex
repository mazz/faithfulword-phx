defmodule FaithfulWord.Videos do
  @moduledoc """
  The boundary for the Videos system.
  """

  import Ecto.Query, warn: false
  import FaithfulWord.Videos.MetadataFetcher
  import FaithfulWord.Videos.CaptionsFetcher
  ...
  @captions_fetcher Application.get_env(:faithful_word, :captions_fetcher)
  ...
  defp get_metadata_fetcher(video_url) do
    cond do
      # Application.get_env(:faithful_word, :use_test_video_metadata_fetcher) ->
