defmodule FaithfulWord.Videos.MetadataFetcher.Youtube do
  ...
  #   #video
  #   # conn |> GoogleApi.YouTube.V3.Api.Videos.youtube_videos_list("snippet", maxResults: 50, id: "yea9PLUMuzs", key: "AIzaSyBbuoNdhYXnV8BBJS1naPAMuKe1kKyb4jI")
  ...
  defp do_fetch_playlist_item_list_metadata(playlist_id, api_key) do
    ...
    # conn |> YouTubeChannels.youtube_channels_list("contentDetails", forUsername: "sanderson1611", key: "AIzaSyBbuoNdhYXnV8BBJS1naPAMuKe1kKyb4jI")

    # sanderson1611 playlist
    # conn = GoogleApi.YouTube.V3.Connection.new()
    # conn |> GoogleApi.YouTube.V3.Api.PlaylistItems.youtube_playlist_items_list("snippet", maxResults: 50, playlistId: "UUq7BdmVpQsay5XrwOgMhN5w", key: "AIzaSyBbuoNdhYXnV8BBJS1naPAMuKe1kKyb4jI")

    # video
    # conn |> GoogleApi.YouTube.V3.Api.Videos.youtube_videos_list("snippet", maxResults: 50, id: "qSVJOYxg1dA", key: "AIzaSyBbuoNdhYXnV8BBJS1naPAMuKe1kKyb4jI")
    ...
    # conn |> GoogleApi.YouTube.V3.Api.PlaylistItems.youtube_playlist_items_list("snippet", maxResults: 50, playlistId: "UUq7BdmVpQsay5XrwOgMhN5w", pageToken: "CDIQAA", key: "AIzaSyBbuoNdhYXnV8BBJS1naPAMuKe1kKyb4jI")
