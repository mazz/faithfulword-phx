defmodule FaithfulWordApi.LanguageIdentifierV12View do
    ...
    %{
      result:
        render_many(
          ...
          LanguageIdentifierV12View,
          "language_identifier_v12.json"
        ),
      status: "success",
      version: "1.2"
    }
  ...
  def render("language_identifier_v12.json", %{language_identifier_v12: language_identifier_v12}) do
    %{
      languageIdentifier: language_identifier_v12.identifier,
      sourceMaterial: language_identifier_v12.source_material,
      supported: language_identifier_v12.supported
    }
  end
end
