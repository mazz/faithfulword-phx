defmodule FaithfulWordApi.MediaItemsSearch do
  ...
  def normalize_bible_book_abbreviations(search_string) do
    no_blanks_in_abbrev_search_string =
      replace_and_remove_blanks_from_numbered_books(search_string)
  ...
  def bible() do
    [
      %{
        "book" => "1 chronicles",
        "abbreviations" => ["1 chr", "1 chr", "1 ch", "1chr", "1ch", "1chronicles"]
      },
      %{
        "book" => "1 corinthians",
        "abbreviations" => ["1co", "1cr", "1cor", "1 cor", "1 co", "1 cr", "1corinthians"]
      },
      %{
        "book" => "1 john",
        "abbreviations" => ["1 jn", "1 jhn", "1jhn", "1 j", "1j", "1jn", "1john"]
      },
      %{
        "book" => "1 kings",
        "abbreviations" => [
      ...
      %{
        "book" => "1 peter",
        "abbreviations" => ["1 pet", "1 pe", "1 pt", "1 p", "1pet", "1pe", "1pt", "1p", "1peter"]
      },
      %{
        "book" => "1 samuel",
        "abbreviations" => ["1 sam", "1 sm", "1 sa", "1 s", "1sam", "1sm", "1sa", "1s", "1samuel"]
      },
      %{
      ...
      %{
        "book" => "1 timothy",
        "abbreviations" => ["1 tim", "1 ti", "1 tm", "1tim", "1ti", "1tm", "1timothy"]
      },
      %{
        "book" => "2 chronicles",
        "abbreviations" => ["2 chr", "2 ch", "2 chron", "2chr", "2ch", "2chron", "2chronicles"]
      },
      %{
        "book" => "2 corinthians",
        "abbreviations" => ["2co", "2cr", "2cor", "2 cor", "2 co", "2 cr"]
      },
      %{
        "book" => "2 john",
        "abbreviations" => ["2 jn", "2 jhn", "2jhn", "2 j", "2j", "2jn", "2john", "2corinthians"]
      },
      %{
        "book" => "2 kings",
        "abbreviations" => ["2 kgs", "2 kin", "2 ki", "2kings", "2kgs", "2kin", "2ki", "2kings"]
      },
      %{
        "book" => "2 peter",
        "abbreviations" => ["2 pet", "2 pe", "2 pt", "2 p", "2pet", "2pe", "2pt", "2p", "2peter"]
      },
      %{
        "book" => "2 samuel",
        "abbreviations" => ["2 sam", "2 sm", "2 sa", "2 s", "2sam", "2sm", "2sa", "2s", "2samuel"]
      },
      %{
      ...
      %{
        "book" => "2 timothy",
        "abbreviations" => ["2 tim", "2 ti", "2 tm", "2tim", "2ti", "2tm", "2timothy"]
      },
      %{
        "book" => "3 john",
        "abbreviations" => ["3 jn", "3 jhn", "3jhn", "3 j", "3j", "3jn", "3john"]
      },
